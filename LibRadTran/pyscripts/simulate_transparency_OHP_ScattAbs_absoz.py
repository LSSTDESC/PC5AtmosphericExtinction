...
# With a pure clearsky atmosphere mixing molecular scattering and absorption 
#
# author: sylvielsstfr
# creation date : November 2st 2016
# 
#
#################################################################
import os
...
Atm=['mw','ms']   # short name of atmospheric sky here US standard and  Subarctic winter
